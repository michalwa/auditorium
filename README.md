...
A soundscape playback tool for playing ambient audio for focus, tabletop games, or live performance
...
On Windows you can create a shortcut with the above command and set it to open the console minimized.
...
- Left-click or drag over the 2D area with the left mouse button to move the listening point. Sounds get louder as you get closer to the region center points.
- You can import/export entire projects. Importing will add saved regions to the current project. Exporting will save all currently added audio regions.
- Most cells in the bottom table are editable. Double-click to edit:
  - **Color** &ndash; displayed color of the region in the 2D area
...
- Editing numbers may require using locale-dependent decimal separators, it's kind of stupid.
- Right-click in the bottom table to delete a region, or to delete all regions.

## Development

Why Java? idk, spur of the moment
